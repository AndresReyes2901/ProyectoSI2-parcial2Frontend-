...
import { LogIn, User, BookOpen, GraduationCap,Lock } from 'lucide-react';
...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br bg-[#39935b] p-4">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Lock className="absolute left-3 top-3 h-5 w-5 text-blue-500 group-hover:text-blue-600 transition-colors" />
                  <Input
                    id="password"
                    name="password"
                    type="password"
              ...
              <Button 
                type="submit" 
                className="w-full h-12 bg-[#39935b] hover:bg-[#338552] text-white font-semibold text-lg rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
